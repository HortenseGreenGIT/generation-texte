...
4. Réservez dès maintenant votre ${formData.specificType} pour un séjour ${formData.specificTypeSelect}`;
    ...
    Ecrire un titre : Que faire lors d'un week-end ${formData.specificThematiqueSelect}
...
1. Choisir un hébergement ${formData.specificThematiqueSelect} 
2. Profitez d'expériences {ajouter ici une tournure de phrase naturelle en accord avec ${formData.specificThematiqueSelect}}
3. Découvrir des lieux {ajouter ici une tournure de phrase naturelle en accord avec ${formData.specificThematiqueSelect}}
4. Ajouter une touche d'originalité
5. Voyager de manière responsable
6. Planifier un moment de détente
Organisez votre week-end ${formData.specificThematiqueSelect} avec Hortense`;
}
