...
EN ATTENDANT, ECRIRE "BIENTOT DISPONIBLE"`;
    ...
    Ecrire un titre : Que faire lors d'un week-end ${formData.thematique} ? Ce titre est à adapter pour convenir à un titre écrit par un humain, de manière naturelle.
